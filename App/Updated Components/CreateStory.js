...
export default function CreateStory({ navigation }) {
  ...
  const character1textHandler = async text => {
    ...
    if (
      ...
      character1Text.includes('WALKED') ||
      character1Text.includes('MOVED') ||
      ...
      console.log(`Action: ${action1}`);
      set_character1_movement(1);
      set_character1_movementtime(14000);
    ...
    if (
      ...
      console.log(`Action: ${action1}`);
      set_character1_movement(1);
      set_character1_movementtime(7000);
    }
    ...
    if (
      ...
      character1Text.includes('TROTTED') 
      
    ) {
      await setAction1('trot');
      console.log(`Action: ${action1}`);
      set_character1_movement(1);
      set_character1_movementtime(8000);
    }
  };
  ...
  const character2textHandler = async text => {
    ...
    if (
      ...
      character2Text.includes('WALKED') ||
      character2Text.includes('WALKING') ||
      character2Text.includes('MOVING') ||
      character2Text.includes('MOVE') ||
      character2Text.includes('MOVED')
    ) {
      await setAction2('walk_reverse');
      console.log(`Action: ${action2}`);
      set_character2_movement(1);
      set_character2_movementtime(14000);
      console.log(character2_movementtime);

      //  setVar_character1(require('.././assets/result/test8.gif'));
    }
    if (character2Text.includes('TAIL')) {
    ...
    if (
      ...
      console.log(`Action: ${action2}`);
      set_character2_movement(1);
      set_character2_movementtime(7000);
      //setVar_character1(require('.././assets/result/test7.gif'));
    }
    ...
    if (
      ...
      character2Text.includes('TROTTED') ||
      character2Text.includes('TROTTING')
    ) {
      await setAction2('trot_reverse');
      console.log(`Action: ${action2}`);
      set_character2_movement(1);
      set_character2_movementtime(8000);
    }
  };
  ...
  const mainlistoptions = async item => {
    ...
    if (item.key == '07') {
      ...
      setTimeout(function () {
        capturescreen('frame-' + frameNo+1 + '-image-0');
        Animated.timing(fadeAnim, {
          toValue: 0,
          duration: 3000,
        }).start();
    ...
    if (item.key == '08') {
      ...
      fetch(`${serverlink}/saveStory?userName=${currentuser.uid}&storyName=${title}`, {
        method: 'GET',
        headers: {
          Accept: 'application/json',
          'Content-Type': 'application/json',
        ...
        .then(obj => {
          console.log(obj);
          fetch(`${serverlink}/convertVideo?userName=${currentuser.uid}&storyName=${title}`, {
            method: 'GET',
            headers: {
              Accept: 'application/json',
              'Content-Type': 'application/json',
  ...
  const changeBackground = item => {
    ...
    if (item.key == '13') {
      setBackground(require('.././assets/background/background12.jpg'));
    }
  };
  ...
  const backgroundflatlist = [
    ...
    { key: '13', src: require('.././assets/background/background12.jpg') },
  ];
  ...
  return (
    <LandscapeView>
      ...
      <ImageBackground style={styles.container} source={background}>
        ...
        {showTitle 
        ?<View style={{backgroundColor : 'black', height:height, width:width, opacity:0.8}}>

        <TextInput
                style={[styles.inputtext,{width:300,top:100, left:150,backgroundColor:'transparent'}]}
        ...
        <TouchableHighlight
          style={[styles.inputtext,{width:300,top:120, left:150,backgroundColor:'black'}]}
          onPress={titlesubmit}
