...
from flask import jsonify,send_file, send_from_directory, safe_join, abort,current_app
app=Flask(__name__)
...
def main():
    ...
    # parser.add_argument("--checkpoint", default='checkpoints/svg.pth.tar', help="path to checkpoint to restore")

    # parser.add_argument("--source_image", default='source.png', help="path to source image")
    # parser.add_argument("--driving_video", default='source.gif', help="path to driving video")
    ...
    checkpoint='checkpoints/svg.pth.tar'
    source_image='assets/lion.png'
    driving_video='assets/lion.gif'
...
def remove_background():
	#print('removing backgrounf')
	im8 = 'result.gif'
	im = Image.open(im8)                  
	im.save('assets/result4.gif', save_all = True, disposal = 2, transparency = 0)
